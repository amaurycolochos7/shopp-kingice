...
const Products = {
  ...
  _getDefaultProducts() {
    ...
    return [
      // Cadenas
      { id: 1, name: 'Cadena de Oro 14k Full Ice con Púas y Diamantes Baguette', slug: 'cadena-oro-14k-full-ice', category: 'cadenas', categoryName: 'Cadenas', categoryId: 1, description: 'Impresionante cadena de oro de 14 quilates con diseño full ice, púas decorativas y diamantes baguette incrustados. Una pieza maestra de joyería que combina la agresividad del diseño con la elegancia del oro.', basePrice: 45000, images: ['images/products/cadenas/cadena-1.jpg', 'images/products/cadenas/cadena-2.jpg', MOCKUP], options: { 'Largo': ['18"', '20"', '22"', '24"'], 'Kilates': ['10k', '14k', '18k'] }, active: true, featured: true, sku: 'CAD-001' },
      { id: 2, name: 'Cadena Cubana de Oro Rosa con Pavé Alternado de Circonias', slug: 'cadena-cubana-oro-rosa', category: 'cadenas', categoryName: 'Cadenas', categoryId: 1, description: 'Elegante cadena cubana en oro rosa con pavé alternado de circonias brillantes. El contraste entre el oro rosa y las piedras crea un efecto visual espectacular.', basePrice: 38000, images: ['images/products/cadenas/cadena-3.jpg', 'images/products/cadenas/cadena-4.webp', MOCKUP], options: { 'Largo': ['18"', '20"', '22"'], 'Kilates': ['10k', '14k'] }, active: true, featured: true, sku: 'CAD-002' },
      ...
      { id: 5, name: 'Anillo Solitario de Oro con Diamante Central', slug: 'anillo-solitario-diamante', category: 'anillos', categoryName: 'Anillos', categoryId: 2, description: 'Clásico anillo solitario con un impresionante diamante central montado en oro. La montura permite una máxima reflexión de la luz.', basePrice: 35000, images: ['images/products/anillos/anillo-3.jpg', 'images/products/anillos/anillo-4.jpg', MOCKUP], options: { 'Talla': ['6', '7', '8', '9', '10'], 'Kilates': ['14k', '18k'] }, active: true, featured: true, sku: 'ANI-002' },
      { id: 6, name: 'Anillo de Oro con Diseño Cubano', slug: 'anillo-cubano-oro', category: 'anillos', categoryName: 'Anillos', categoryId: 2, description: 'Anillo con diseño cubano en oro macizo. Un diseño audaz y contemporáneo que hace una declaración de estilo.', basePrice: 22000, images: ['images/products/anillos/anillo-4.jpg', 'images/products/anillos/anillo-5.jpg', MOCKUP], options: { 'Talla': ['7', '8', '9', '10', '11', '12'], 'Kilates': ['10k', '14k'] }, active: true, featured: false, sku: 'ANI-003' },
      // Aretes
      { id: 7, name: 'Aretes Magic Alhambra Oro Blanco con Diamantes', slug: 'aretes-magic-alhambra-oro-blanco', category: 'aretes', categoryName: 'Aretes', categoryId: 3, description: 'Inspirados en el diseño icónico Alhambra, estos aretes de oro blanco están adornados con diamantes de primera calidad.', basePrice: 42000, images: ['images/products/aretes/aretes-1.png', 'images/products/aretes/aretes-2.png', MOCKUP], options: { 'Material': ['Oro Blanco 14k', 'Oro Blanco 18k'] }, active: true, featured: true, sku: 'ARE-001' },
      { id: 8, name: 'Aretes Magic Alhambra Oro Rosa con Diamantes y Madreperla', slug: 'aretes-alhambra-oro-rosa', category: 'aretes', categoryName: 'Aretes', categoryId: 3, description: 'Aretes de diseño asimétrico con motivos florales en oro rosa, combinando diamantes y madreperla negra para un contraste elegante.', basePrice: 48000, images: ['images/products/aretes/aretes-2.png', 'images/products/aretes/aretes-3.png', MOCKUP], options: { 'Material': ['Oro Rosa 14k', 'Oro Rosa 18k'] }, active: true, featured: true, sku: 'ARE-002' },
      { id: 9, name: 'Aretes Vintage Alhambra Oro Amarillo con Diamantes', slug: 'aretes-vintage-alhambra', category: 'aretes', categoryName: 'Aretes', categoryId: 3, description: 'Clásicos aretes con el diseño Vintage Alhambra en oro amarillo, adornados con diamantes de alta calidad. Perfectos para cualquier ocasión.', basePrice: 38000, images: ['images/products/aretes/aretes-3.png', 'images/products/aretes/aretes-4.png', MOCKUP], options: { 'Material': ['Oro Amarillo 14k', 'Oro Amarillo 18k'] }, active: true, featured: false, sku: 'ARE-003' },
      // Pulsos
      ...
      { id: 12, name: 'Pulso de Oro Tejido Monaco Shade Pavé', slug: 'pulso-monaco-shade', category: 'pulsos', categoryName: 'Pulsos', categoryId: 4, description: 'Elegante pulso con tejido Monaco y acabado en pavé sombreado. Un diseño moderno que combina tradición y vanguardia.', basePrice: 28000, images: ['images/products/pulsos/pulso-6.jpg', 'images/products/pulsos/pulso-4.jpg', MOCKUP], options: { 'Largo': ['7"', '7.5"', '8"'], 'Kilates': ['10k', '14k'] }, active: true, featured: false, sku: 'PUL-003' },
      // Dijes
      { id: 13, name: 'Dije Ojo de Tigre en Oro con Diamantes', slug: 'dije-ojo-tigre-oro', category: 'dijes', categoryName: 'Dijes', categoryId: 5, description: 'Hermoso dije tallado con piedra ojo de tigre natural, engarzado en oro y rodeado de diamantes. Una pieza única con energía protectora.', basePrice: 18000, images: ['images/products/dijes/dije-1.png', 'images/products/dijes/dije-2.png', MOCKUP], options: { 'Kilates': ['10k', '14k'], 'Cadena': ['Sin cadena', 'Cadena 18"', 'Cadena 20"'] }, active: true, featured: true, sku: 'DIJ-001' },
      { id: 14, name: 'Dije Estrella Diamantes en Oro Blanco', slug: 'dije-estrella-diamantes', category: 'dijes', categoryName: 'Dijes', categoryId: 5, description: 'Dije con forma de estrella en oro blanco, completamente cubierto de micro-diamantes. Brilla con intensidad bajo cualquier luz.', basePrice: 25000, images: ['images/products/dijes/dije-2.png', 'images/products/dijes/dije-3.png', MOCKUP], options: { 'Kilates': ['14k', '18k'], 'Cadena': ['Sin cadena', 'Cadena 18"', 'Cadena 22"'] }, active: true, featured: false, sku: 'DIJ-002' },
      { id: 15, name: 'Dije Celestial de Oro con Piedras Preciosas', slug: 'dije-celestial-oro', category: 'dijes', categoryName: 'Dijes', categoryId: 5, description: 'Un dije inspirado en el cielo nocturno, elaborado en oro con una combinación de piedras preciosas que simulan las constelaciones.', basePrice: 22000, images: ['images/products/dijes/dije-3.png', 'images/products/dijes/dije-1.png', MOCKUP], options: { 'Kilates': ['10k', '14k'], 'Cadena': ['Sin cadena', 'Cadena 20"'] }, active: true, featured: false, sku: 'DIJ-003' },
      // Relojes
      { id: 16, name: 'Reloj de Oro con Bisel de Diamantes', slug: 'reloj-oro-bisel-diamantes', category: 'relojes', categoryName: 'Relojes', categoryId: 6, description: 'Reloj de lujo en oro macizo con bisel completamente cubierto de diamantes. Un reloj que no solo dice la hora, sino que define tu estatus.', basePrice: 85000, images: ['images/products/relojes/reloj-1.jpg', 'images/products/relojes/reloj-2.jpg', MOCKUP], options: { 'Talla': ['38mm', '40mm', '42mm'] }, active: true, featured: true, sku: 'REL-001' },
      { id: 17, name: 'Reloj Oro Rosa Full Iced', slug: 'reloj-oro-rosa-iced', category: 'relojes', categoryName: 'Relojes', categoryId: 6, description: 'Espectacular reloj en oro rosa con diamantes cubriendo cada superficie. Una obra de arte de la relojería de lujo.', basePrice: 120000, images: ['images/products/relojes/reloj-2.jpg', 'images/products/relojes/reloj-3.jpg', MOCKUP], options: { 'Talla': ['40mm', '42mm'] }, active: true, featured: true, sku: 'REL-002' },
      { id: 18, name: 'Reloj Clásico de Oro con Caratula Diamantada', slug: 'reloj-clasico-diamantado', category: 'relojes', categoryName: 'Relojes', categoryId: 6, description: 'Reloj clásico con caja de oro y carátula adornada con diamantes. Combina el estilo clásico con un toque contemporáneo.', basePrice: 65000, images: ['images/products/relojes/reloj-3.jpg', 'images/products/relojes/reloj-1.jpg', MOCKUP], options: { 'Talla': ['36mm', '38mm', '40mm'] }, active: true, featured: false, sku: 'REL-003' },
      // Diamantes
