...
const Collections = {
  ...
  _getDefaults() {
    return [
      ...
      { id: 4, name: 'Pulsos', slug: 'pulsos', order: 4, image: 'images/categories/pulsos.webp' },
      { id: 5, name: 'Dijes', slug: 'dijes', order: 5, image: 'images/categories/dijes.webp' },
      { id: 6, name: 'Relojes', slug: 'relojes', order: 6, image: 'images/categories/relojes.webp' },
      { id: 7, name: 'Diamantes', slug: 'diamantes', order: 7, image: 'images/categories/diamantes.jpg' },
      { id: 8, name: 'Religiosos', slug: 'religiosos', order: 8, image: 'images/categories/religiosos.webp' }
    ];
  },
...
const Products = {
  ...
  _getDefaultProducts() {
    const MOCKUP = 'images/products/mockup-kig.png';
    return [
      // Cadenas
      { id: 1, name: 'Cadena de Oro 14k Full Ice con Púas y Diamantes Baguette', slug: 'cadena-oro-14k-full-ice', category: 'cadenas', categoryName: 'Cadenas', categoryId: 1, description: 'Impresionante cadena de oro de 14 quilates con diseño full ice, púas decorativas y diamantes baguette incrustados. Una pieza maestra de joyería que combina la agresividad del diseño con la elegancia del oro.', basePrice: 45000, images: ['images/products/cadenas/cadena-1.webp', 'images/products/cadenas/cadena-2.webp', MOCKUP], options: { 'Largo': ['18"', '20"', '22"', '24"'], 'Kilates': ['10k', '14k', '18k'] }, active: true, featured: true, sku: 'CAD-001' },
      { id: 2, name: 'Cadena Cubana de Oro Rosa con Pavé Alternado de Circonias', slug: 'cadena-cubana-oro-rosa', category: 'cadenas', categoryName: 'Cadenas', categoryId: 1, description: 'Elegante cadena cubana en oro rosa con pavé alternado de circonias brillantes. El contraste entre el oro rosa y las piedras crea un efecto visual espectacular.', basePrice: 38000, images: ['images/products/cadenas/cadena-3.webp', 'images/products/cadenas/cadena-4.webp', MOCKUP], options: { 'Largo': ['18"', '20"', '22"'], 'Kilates': ['10k', '14k'] }, active: true, featured: true, sku: 'CAD-002' },
      { id: 3, name: 'Cadena de Oro Tejido Torzal Clásica', slug: 'cadena-torzal-clasica', category: 'cadenas', categoryName: 'Cadenas', categoryId: 1, description: 'Cadena clásica con tejido torzal en oro amarillo. Un diseño atemporal que nunca pasa de moda, perfecto para uso diario o para ocasiones especiales.', basePrice: 15000, images: ['images/products/cadenas/cadena-8.jpg', 'images/products/cadenas/cadena-5.jpg', MOCKUP], options: { 'Largo': ['18"', '20"', '22"', '24"'], 'Kilates': ['10k', '14k'] }, active: true, featured: false, sku: 'CAD-003' },
      // Anillos
      { id: 4, name: 'Anillo de Oro con Diamantes Pavé', slug: 'anillo-oro-diamante-pave', category: 'anillos', categoryName: 'Anillos', categoryId: 2, description: 'Elegante anillo de oro con diamantes en pavé que rodean toda la banda. Un diseño sofisticado que refleja la luz desde todos los ángulos.', basePrice: 28000, images: ['images/products/anillos/anillo-2.jpg', 'images/products/anillos/anillo-3.jpg', MOCKUP], options: { 'Talla': ['6', '7', '8', '9', '10', '11'], 'Kilates': ['10k', '14k', '18k'] }, active: true, featured: true, sku: 'ANI-001' },
      { id: 5, name: 'Anillo Solitario de Oro con Diamante Central', slug: 'anillo-solitario-diamante', category: 'anillos', categoryName: 'Anillos', categoryId: 2, description: 'Clásico anillo solitario con un impresionante diamante central montado en oro. La montura permite una máxima reflexión de la luz.', basePrice: 35000, images: ['images/products/anillos/anillo-3.jpg', 'images/products/anillos/anillo-4.webp', MOCKUP], options: { 'Talla': ['6', '7', '8', '9', '10'], 'Kilates': ['14k', '18k'] }, active: true, featured: true, sku: 'ANI-002' },
      { id: 6, name: 'Anillo de Oro con Diseño Cubano', slug: 'anillo-cubano-oro', category: 'anillos', categoryName: 'Anillos', categoryId: 2, description: 'Anillo con diseño cubano en oro macizo. Un diseño audaz y contemporáneo que hace una declaración de estilo.', basePrice: 22000, images: ['images/products/anillos/anillo-4.webp', 'images/products/anillos/anillo-5.jpg', MOCKUP], options: { 'Talla': ['7', '8', '9', '10', '11', '12'], 'Kilates': ['10k', '14k'] }, active: true, featured: false, sku: 'ANI-003' },
      // Aretes
      { id: 7, name: 'Aretes Magic Alhambra Oro Blanco con Diamantes', slug: 'aretes-magic-alhambra-oro-blanco', category: 'aretes', categoryName: 'Aretes', categoryId: 3, description: 'Inspirados en el diseño icónico Alhambra, estos aretes de oro blanco están adornados con diamantes de primera calidad.', basePrice: 42000, images: ['images/products/aretes/aretes-1.webp', 'images/products/aretes/aretes-2.webp', MOCKUP], options: { 'Material': ['Oro Blanco 14k', 'Oro Blanco 18k'] }, active: true, featured: true, sku: 'ARE-001' },
      { id: 8, name: 'Aretes Magic Alhambra Oro Rosa con Diamantes y Madreperla', slug: 'aretes-alhambra-oro-rosa', category: 'aretes', categoryName: 'Aretes', categoryId: 3, description: 'Aretes de diseño asimétrico con motivos florales en oro rosa, combinando diamantes y madreperla negra para un contraste elegante.', basePrice: 48000, images: ['images/products/aretes/aretes-2.webp', 'images/products/aretes/aretes-3.webp', MOCKUP], options: { 'Material': ['Oro Rosa 14k', 'Oro Rosa 18k'] }, active: true, featured: true, sku: 'ARE-002' },
      { id: 9, name: 'Aretes Vintage Alhambra Oro Amarillo con Diamantes', slug: 'aretes-vintage-alhambra', category: 'aretes', categoryName: 'Aretes', categoryId: 3, description: 'Clásicos aretes con el diseño Vintage Alhambra en oro amarillo, adornados con diamantes de alta calidad. Perfectos para cualquier ocasión.', basePrice: 38000, images: ['images/products/aretes/aretes-3.webp', 'images/products/aretes/aretes-4.webp', MOCKUP], options: { 'Material': ['Oro Amarillo 14k', 'Oro Amarillo 18k'] }, active: true, featured: false, sku: 'ARE-003' },
      // Pulsos
      { id: 10, name: 'Pulso de Oro Tejido Franco con Diamantes', slug: 'pulso-oro-franco-diamantes', category: 'pulsos', categoryName: 'Pulsos', categoryId: 4, description: 'Impresionante pulso con tejido franco en oro macizo, decorado con diamantes incrustados. Una pieza robusta y elegante a la vez.', basePrice: 32000, images: ['images/products/pulsos/pulso-1.jpg', 'images/products/pulsos/pulso-2.jpg', MOCKUP], options: { 'Largo': ['7"', '7.5"', '8"', '8.5"'], 'Kilates': ['10k', '14k'] }, active: true, featured: true, sku: 'PUL-001' },
      { id: 11, name: 'Pulso de Oro Cubano con Pavé', slug: 'pulso-cubano-pave', category: 'pulsos', categoryName: 'Pulsos', categoryId: 4, description: 'Pulso cubano clásico en oro con pavé de diamantes que recubre cada eslabón. El brillo es incomparable.', basePrice: 45000, images: ['images/products/pulsos/pulso-2.jpg', 'images/products/pulsos/pulso-3.jpg', MOCKUP], options: { 'Largo': ['7"', '8"', '8.5"'], 'Kilates': ['14k', '18k'] }, active: true, featured: true, sku: 'PUL-002' },
      { id: 12, name: 'Pulso de Oro Tejido Monaco Shade Pavé', slug: 'pulso-monaco-shade', category: 'pulsos', categoryName: 'Pulsos', categoryId: 4, description: 'Elegante pulso con tejido Monaco y acabado en pavé sombreado. Un diseño moderno que combina tradición y vanguardia.', basePrice: 28000, images: ['images/products/pulsos/pulso-6.webp', 'images/products/pulsos/pulso-4.jpg', MOCKUP], options: { 'Largo': ['7"', '7.5"', '8"'], 'Kilates': ['10k', '14k'] }, active: true, featured: false, sku: 'PUL-003' },
      // Dijes
      { id: 13, name: 'Dije Ojo de Tigre en Oro con Diamantes', slug: 'dije-ojo-tigre-oro', category: 'dijes', categoryName: 'Dijes', categoryId: 5, description: 'Hermoso dije tallado con piedra ojo de tigre natural, engarzado en oro y rodeado de diamantes. Una pieza única con energía protectora.', basePrice: 18000, images: ['images/products/dijes/dije-1.webp', 'images/products/dijes/dije-2.webp', MOCKUP], options: { 'Kilates': ['10k', '14k'], 'Cadena': ['Sin cadena', 'Cadena 18"', 'Cadena 20"'] }, active: true, featured: true, sku: 'DIJ-001' },
      { id: 14, name: 'Dije Estrella Diamantes en Oro Blanco', slug: 'dije-estrella-diamantes', category: 'dijes', categoryName: 'Dijes', categoryId: 5, description: 'Dije con forma de estrella en oro blanco, completamente cubierto de micro-diamantes. Brilla con intensidad bajo cualquier luz.', basePrice: 25000, images: ['images/products/dijes/dije-2.webp', 'images/products/dijes/dije-3.webp', MOCKUP], options: { 'Kilates': ['14k', '18k'], 'Cadena': ['Sin cadena', 'Cadena 18"', 'Cadena 22"'] }, active: true, featured: false, sku: 'DIJ-002' },
      { id: 15, name: 'Dije Celestial de Oro con Piedras Preciosas', slug: 'dije-celestial-oro', category: 'dijes', categoryName: 'Dijes', categoryId: 5, description: 'Un dije inspirado en el cielo nocturno, elaborado en oro con una combinación de piedras preciosas que simulan las constelaciones.', basePrice: 22000, images: ['images/products/dijes/dije-3.webp', 'images/products/dijes/dije-1.webp', MOCKUP], options: { 'Kilates': ['10k', '14k'], 'Cadena': ['Sin cadena', 'Cadena 20"'] }, active: true, featured: false, sku: 'DIJ-003' },
      // Relojes
      { id: 16, name: 'Reloj de Oro con Bisel de Diamantes', slug: 'reloj-oro-bisel-diamantes', category: 'relojes', categoryName: 'Relojes', categoryId: 6, description: 'Reloj de lujo en oro macizo con bisel completamente cubierto de diamantes. Un reloj que no solo dice la hora, sino que define tu estatus.', basePrice: 85000, images: ['images/products/relojes/reloj-1.webp', 'images/products/relojes/reloj-2.webp', MOCKUP], options: { 'Talla': ['38mm', '40mm', '42mm'] }, active: true, featured: true, sku: 'REL-001' },
      { id: 17, name: 'Reloj Oro Rosa Full Iced', slug: 'reloj-oro-rosa-iced', category: 'relojes', categoryName: 'Relojes', categoryId: 6, description: 'Espectacular reloj en oro rosa con diamantes cubriendo cada superficie. Una obra de arte de la relojería de lujo.', basePrice: 120000, images: ['images/products/relojes/reloj-2.webp', 'images/products/relojes/reloj-3.webp', MOCKUP], options: { 'Talla': ['40mm', '42mm'] }, active: true, featured: true, sku: 'REL-002' },
      { id: 18, name: 'Reloj Clásico de Oro con Caratula Diamantada', slug: 'reloj-clasico-diamantado', category: 'relojes', categoryName: 'Relojes', categoryId: 6, description: 'Reloj clásico con caja de oro y carátula adornada con diamantes. Combina el estilo clásico con un toque contemporáneo.', basePrice: 65000, images: ['images/products/relojes/reloj-3.webp', 'images/products/relojes/reloj-1.webp', MOCKUP], options: { 'Talla': ['36mm', '38mm', '40mm'] }, active: true, featured: false, sku: 'REL-003' },
      // Diamantes
      { id: 19, name: 'Diamante Natural Corte Brillante 1.5ct', slug: 'diamante-brillante-1-5ct', category: 'diamantes', categoryName: 'Diamantes', categoryId: 7, description: 'Diamante natural de corte brillante redondo con 1.5 quilates. Certificado GIA con claridad VS1 y color F. Ideal para engaste en anillo o dije.', basePrice: 95000, images: ['images/products/diamantes/diamante-1.jpg', 'images/products/diamantes/diamante-2.jpg', MOCKUP], options: { 'Certificación': ['GIA', 'AGS'] }, active: true, featured: true, sku: 'DIA-001' },
      { id: 20, name: 'Diamante Corte Princess 2.0ct', slug: 'diamante-princess-2ct', category: 'diamantes', categoryName: 'Diamantes', categoryId: 7, description: 'Impresionante diamante con corte princess de 2.0 quilates. Su forma cuadrada maximiza el brillo y el fuego del diamante.', basePrice: 150000, images: ['images/products/diamantes/diamante-2.jpg', 'images/products/diamantes/diamante-3.jpg', MOCKUP], options: { 'Certificación': ['GIA', 'IGI'] }, active: true, featured: true, sku: 'DIA-002' },
      { id: 21, name: 'Par de Diamantes Corte Oval 0.8ct c/u', slug: 'diamantes-oval-par', category: 'diamantes', categoryName: 'Diamantes', categoryId: 7, description: 'Par de diamantes ovales perfectamente emparejados, 0.8 quilates cada uno. Ideales para aretes o pendientes.', basePrice: 72000, images: ['images/products/diamantes/diamante-3.jpg', 'images/products/diamantes/diamante-4.jpg', MOCKUP], options: { 'Certificación': ['GIA'] }, active: true, featured: false, sku: 'DIA-003' },
      // Religiosos
      { id: 22, name: 'Cruz de Oro con Diamantes Full Iced', slug: 'cruz-oro-full-iced', category: 'religiosos', categoryName: 'Religiosos', categoryId: 8, description: 'Cruz elaborada en oro macizo, completamente cubierta de micro-diamantes. Una pieza devocional que combina fe y artesanía de alta joyería.', basePrice: 35000, images: ['images/products/religiosos/religioso-1.webp', 'images/products/religiosos/religioso-2.webp', MOCKUP], options: { 'Kilates': ['10k', '14k', '18k'], 'Cadena': ['Sin cadena', 'Cadena 20"', 'Cadena 24"'] }, active: true, featured: true, sku: 'REL-R01' },
      { id: 23, name: 'San Judas Tadeo de Oro con Piedras', slug: 'san-judas-oro-piedras', category: 'religiosos', categoryName: 'Religiosos', categoryId: 8, description: 'Dije de San Judas Tadeo tallado en oro y adornado con piedras preciosas. Una pieza de gran detalle y devoción.', basePrice: 28000, images: ['images/products/religiosos/religioso-2.webp', 'images/products/religiosos/religioso-3.webp', MOCKUP], options: { 'Kilates': ['10k', '14k'], 'Cadena': ['Sin cadena', 'Cadena 22"', 'Cadena 24"'] }, active: true, featured: false, sku: 'REL-R02' },
      { id: 24, name: 'Virgen de Guadalupe de Oro con Brillantes', slug: 'virgen-guadalupe-oro', category: 'religiosos', categoryName: 'Religiosos', categoryId: 8, description: 'Hermosa imagen de la Virgen de Guadalupe elaborada en oro con brillantes incrustados. Una pieza devocional de gran valor artístico.', basePrice: 32000, images: ['images/products/religiosos/religioso-3.webp', 'images/products/religiosos/religioso-4.webp', MOCKUP], options: { 'Kilates': ['10k', '14k', '18k'], 'Cadena': ['Sin cadena', 'Cadena 20"', 'Cadena 22"'] }, active: true, featured: false, sku: 'REL-R03' }
    ];
  },
